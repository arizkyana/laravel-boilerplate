...
@section('content')
    ...
    <form action="{{ action('Master\DinkesController@update', ['id' => $dinkes->id]) }}" method="post">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <input type="hidden" name="id" value="{{ $dinkes->id  }}"/>
                ...
                <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nama" value="{{ $dinkes->nama }}" required/>
                            @if ($errors->has('nama'))
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" data-placeholder="Pilih Kecamatan" name="kecamatan"
                                        ...
                                        @foreach ($kecamatan as $item)
                                            <option value="{{$item->kecamatan_id}}" {{ $item->kecamatan_id == $dinkes->kecamatan ? 'selected' : '' }}>{{$item->nama_kecamatan}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="kelurahan" data-placeholder="Pilih Kelurahan" class="form-control"
                                        ...
                                        @foreach ($kelurahan as $item)
                                            <option value="{{ $item->kelurahan_id }}" {{ $item->kelurahan_id == $dinkes->kelurahan ? 'selected' : '' }}>{{$item->nama_kelurahan}}</option>
                                        @endforeach
                                    </select>
