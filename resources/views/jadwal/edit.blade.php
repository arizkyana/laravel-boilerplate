                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea required name="keterangan" id="keterangan" class="form-control" cols="30"
                                      rows="10">{{ trim($jadwal->keterangan) }}</textarea>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <select name="jenis" id="jenis" class="form-control"
                                                data-placeholder="Pilih Jenis Lokasi">
                                            <option value=""></option>
                                            <option value="1" {{ $jadwal->jenis == 1 ? 'selected' : '' }}>Sekolah
                                            </option>
                                            <option value="2" {{ $jadwal->jenis == 2 ? 'selected' : '' }}>Fasilitas
                                                Kesehatan
                                            </option>
                                            <option value="3" {{ $jadwal->jenis == 3 ? 'selected' : '' }}>Perkimtan
                                            </option>
                                            <option value="4" {{ $jadwal->jenis == 4 ? 'selected' : '' }}>Apartment
                                            </option>
                                            <option value="5" {{ $jadwal->jenis == 5 ? 'selected' : '' }}>Perumahan
                                            </option>
                                        </select>
                                        @if ($errors->has('jenis'))
                                            <span class="help-block">
                                    ...
                                    <div class="col-md-9">
                                        <select name="alamat" id="alamat" class="form-control"
                                            ...
                                            @foreach ($lokasi as $key => $item)
                                                <option value="{{ $item->id }}" {{ $jadwal->alamat->id == $item->id ? 'selected' : '' }}>{{ isset($item->name) ? $item->name : $item->nama }}</option>
                                            @endforeach
                                        </select>
