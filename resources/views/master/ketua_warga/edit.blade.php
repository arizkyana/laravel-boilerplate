...
@section('content')
    ...
    <form action="{{ action('Master\KetuaWargaController@update', ['id' => $petugas->id]) }}" method="post">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <div class="form-group ">
                    <div class="row">
                        <label for="rtrw" class="col-md-3">&nbsp;</label>
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-6">
                ...
                <fieldset>
                    ...
                    <div class="form-group {{ $errors->has('ketua') ? ' has-error' : '' }}">
                        <div class="row">
                            <label for="ketua" class="col-md-3">Ketua
                                <smal class="text-danger">*</smal>
                            </label>
                            <div class="col-md-9">
                                <div class="radio">
                                    <label>
                                        <input type="radio" value="1"
                                               name="ketua" {{ $petugas->ketua == 1 ? 'checked' : '' }}/> RT
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" value="2"
                                               name="ketua" {{ $petugas->ketua == 2 ? 'checked' : '' }}/> RW
                                    </label>
                                </div>
                                @if ($errors->has('ketua'))
                                    <span class="help-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="masa_bakti_mulai" id="masa_bakti_mulai"
                                           class="form-control" value="{{ $petugas->masa_bakti_mulai }}"/>
                                    @if ($errors->has('masa_bakti_mulai'))
                                        <span class="help-block">
                                        <strong>{{ $errors->first('masa_bakti_mulai') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="form-group {{ $errors->has('masa_bakti_akhir') ? ' has-error' : '' }}">
                        <div class="row">
                            <label for="" class="col-md-3">Akhir</label>
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </span>
                                    <input type="text" name="masa_bakti_akhir" id="masa_bakti_akhir"
                                           class="form-control" value="{{ $petugas->masa_bakti_akhir }}"/>
                                    @if ($errors->has('masa_bakti_akhir'))
                                        <span class="help-block">
                                        <strong>{{ $errors->first('masa_bakti_akhir') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                ...
                <fieldset>
                    ...
                    <div class="form-group {{ $errors->has('pic_nik') ? ' has-error' : '' }}">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pic_nik" id="pic_nik"
                                       value="{{ isset($pic->nik) ? $pic->nik : '' }}"/>
                    ...
                    <div class="form-group {{ $errors->has('pic_nama') ? ' has-error' : '' }}">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pic_nama" id="pic_nama"
                                       value="{{ isset($pic->name) ? $pic->name : '' }}"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="email" class="form-control" name="email" id="email"
                                       value="{{ isset($pic->email) ? $pic->email : '' }}"/>
                                @if ($errors->has('email'))
                                    <span class="help-block">
                    ...
                    <div class="form-group {{ $errors->has('pic_phone') ? ' has-error' : '' }}">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pic_phone" id="pic_phone"
                                       value="{{ isset($pic->phone) ? $pic->phone : '' }}"/>
            ...
            <div class="ibox-footer text-right">
                ...
                <a href="{{ route('master/ketua_warga') }}" class="btn btn-default">Batal</a>
            </div>
        </div>
    </form>
