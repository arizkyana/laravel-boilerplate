...
@section('content')
    ...
    <form action="{{ action('Master\KetuaWargaController@store') }}" method="post">
        <div class="ibox">
            <div class="ibox-title">
                <h5>Tambah Ketua Warga</h5>
            </div>
                    ...
                    <div class="form-group {{ $errors->has('ketua') ? ' has-error' : '' }}">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="radio">
                                    <label>
                                        <input type="radio" value="1" name="ketua" /> RT
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" value="2" name="ketua" /> RW
                                    </label>
                                </div>
                                @if ($errors->has('ketua'))
                                    <span class="help-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="masa_bakti_mulai" id="masa_bakti_mulai" class="form-control" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="masa_bakti_akhir" id="masa_bakti_akhir" class="form-control" />
