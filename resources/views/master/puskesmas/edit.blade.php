...
@section('content')
    ...
    <form action="{{ action('Master\PuskesmasController@update', ['id' => $puskesmas->id]) }}" method="post">
        <div class="ibox">
            <div class="ibox-title">
                <h5>Edit Puskesmas</h5>
            </div>
            <div class="ibox-content">
                ...
                <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nama" value="{{ $puskesmas->nama }}" required/>
                            @if ($errors->has('nama'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea name="alamat" id="alamat" class="form-control" cols="30"
                                      rows="5">{{$puskesmas->alamat}}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" data-placeholder="Pilih Kecamatan" name="kecamatan"
                                        ...
                                        @foreach ($kecamatan as $item)
                                            <option value="{{$item->kecamatan_id}}" {{ $item->kecamatan_id == $puskesmas->kecamatan ? 'selected' : '' }}>{{$item->nama_kecamatan}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="kelurahan" data-placeholder="Pilih Kelurahan" class="form-control"
                                        ...
                                        @foreach ($kelurahan as $item)
                                            <option value="{{ $item->kelurahan_id }}" {{ $item->kelurahan_id == $puskesmas->kelurahan ? 'selected' : '' }}>{{$item->nama_kelurahan}}</option>
                                        @endforeach
                                    </select>
