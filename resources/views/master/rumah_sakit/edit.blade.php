...
@section('content')
    ...
    <form action="{{ action('Master\RumahSakitController@update', ['id' => $rumah_sakit->id]) }}" method="post">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <input type="hidden" name="id" value="{{ $rumah_sakit->id  }}"/>
                ...
                <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="nama" value="{{ $rumah_sakit->nama }}" required/>
                            @if ($errors->has('nama'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea name="alamat" id="alamat" class="form-control" cols="30"
                                      rows="5">{{$rumah_sakit->alamat}}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" data-placeholder="Pilih Kecamatan" name="kecamatan"
                                        ...
                                        @foreach ($kecamatan as $item)
                                            <option value="{{$item->kecamatan_id}}" {{ $item->kecamatan_id == $rumah_sakit->kecamatan ? 'selected' : '' }}>{{$item->nama_kecamatan}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="kelurahan" data-placeholder="Pilih Kelurahan" class="form-control"
                                        ...
                                        @foreach ($kelurahan as $item)
                                            <option value="{{ $item->kelurahan_id }}" {{ $item->kelurahan_id == $rumah_sakit->kelurahan ? 'selected' : '' }}>{{$item->nama_kelurahan}}</option>
                                        @endforeach
                                    </select>
            ...
            <div class="ibox-footer text-right">
                ...
                <a href="{{ route('master/rumah_sakit') }}" class="btn btn-default">Batal</a>
            </div>
        </div>
    </form>
